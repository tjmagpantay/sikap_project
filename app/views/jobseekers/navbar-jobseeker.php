        ...
        <li x-data="{ profileOpen: false }" class="relative">
          ...
          <div
            ...
            <div class="py-1">
              ...
              <a href="?page=logout"
                class="block px-4 py-2 text-sm text-red-700 rounded-md hover:bg-red-50 hover:text-red-900">
                Sign Out
              </a>
            </div>
          </div>
          ...
          <ul class="flex flex-col gap-3">
            ...
            <li class="pb-3 mb-3 border-b border-gray-200">
              <div class="flex flex-col gap-2">
                <!-- Notifications Link -->
                <a href="?page=notifications-jobseeker" class="flex items-center gap-3 px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-primary" @click="open = false">
                ...
                <!-- Saved Jobs Link -->
                <a href="?page=saved-jobs" class="flex items-center gap-3 px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-primary" @click="open = false">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
            ...
            <li class="pb-3 mb-3 border-b border-gray-200">
              ...
              <div class="flex flex-col gap-2">
                <!-- Profile Link -->
                <a href="?page=profile-jobseeker" class="flex items-center gap-3 px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-primary" @click="open = false">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
                ...
                <!-- Applied Jobs Link -->
                <a href="?page=my-applications" class="flex items-center gap-3 px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-primary" @click="open = false">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
                ...
                <!-- Settings Link -->
                <a href="?page=settings-jobseeker" class="flex items-center gap-3 px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-primary" @click="open = false">
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
            ...
            <li><a href="?page=jobseeker-dashboard" class="flex items-center gap-3 px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-primary" @click="open = false">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
            ...
            <li><a href="?page=browse-jobs" class="flex items-center gap-3 px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-primary" @click="open = false">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
            ...
            <li><a href="?page=programs-jobseeker" class="flex items-center gap-3 px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-primary" @click="open = false">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
            ...
            <li><a href="?page=explore-companies" class="flex items-center gap-3 px-3 py-2 text-base font-medium text-gray-700 rounded-md hover:bg-gray-100 hover:text-primary" @click="open = false">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 text-gray-500">
