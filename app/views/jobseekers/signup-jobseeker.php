...
<div class="flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-2xl">
            ...
            <div class="flex flex-col justify-center w-full px-6 py-8 lg:px-12 xl:px-16">
                <div class="w-full max-w-lg mx-auto">
                    ...
                    <div class="mb-8 text-center">
                        <h2 class="mb-2 text-3xl font-bold text-grayMain">Create Account</h2>
                        <p class="text-sm text-gray-600">Join to find your dream job</p>
                    </div>
                    ...
                    <form class="space-y-6" method="POST" action="?page=signup-jobseeker">
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div class="flex items-center h-5">
                                    <input id="terms" name="terms" type="checkbox" required
                                        class="w-4 h-4 border-gray-300 rounded text-primary focus:ring-primary focus:ring-2">
                                </div>
                            ...
                            <div class="text-sm text-gray-600">
                                ...
                                <a href="" onclick="showTerms(event)" class="font-medium transition-colors text-primary hover:text-primary/80 hover:underline">Terms and Conditions</a> and
                                <a href="" onclick="showPrivacy(event)" class="font-medium transition-colors text-primary hover:text-primary/80 hover:underline">Privacy Policy</a>.
                            </div>
                        </div>
                    ...
                    <!-- Google Sign Up -->
                    <a href="?page=google-signup&type=jobseeker"
                    ...
                    <div class="space-y-3 text-center">
                        <p class="text-sm text-gray-600">
                            ...
                            <a href="?page=login-jobseeker" class="font-medium transition-colors text-primary hover:text-primary/80">Sign In</a>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <!-- Employer sign up link placed below the card -->
        <div class="mt-6 text-center">
            <p class="text-xs text-gray-600">
                Are you an employer?
                <a href="?page=signup-employer" class="font-medium underline transition-colors text-primary hover:text-secondary/80 underline-offset-2">
                    Employer Sign Up
                </a>
            </p>
        </div>
