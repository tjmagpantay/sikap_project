                ...
                <div class="w-full space-y-6 lg:w-8/12">
                    ...
                    <?php if (!empty($attachments)): ?>
                        <div class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
                            <div class="p-4 border-b border-gray-200 sm:p-6 bg-gray-50">
                                ...
                                <p class="mt-1 text-sm text-gray-600">Documents attached to your application</p>
                            </div>
                                    ...
                                    if ($resumeAttachment): ?>
                                        <div class="flex items-center justify-between p-4 transition-colors border border-gray-200 rounded-lg bg-gray-50 hover:bg-gray-100">
                                            <div class="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <p class="text-sm font-medium text-gray-900"><?php echo ucfirst($resumeAttachment['file_type']); ?></p>
                    ...
                    <div class="overflow-hidden bg-white border border-gray-200 shadow-sm rounded-xl">
                        <div class="p-4 border-b border-gray-200 sm:p-6 bg-gray-50">
                            ...
                            <p class="mt-1 text-sm text-gray-600">Your responses to employer's screening questions</p>
                        </div>
                        <div class="p-4 sm:p-6">
