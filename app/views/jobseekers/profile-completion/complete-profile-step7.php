        ...
        <div class="px-4 py-8 bg-white shadow sm:rounded-lg sm:px-10">
            ...
            <div class="mb-6">
                ...
                <div class="w-full h-2 bg-gray-200 rounded">
                    <div class="h-2 rounded bg-primary" style="width: 87.5%"></div>
                </div>
            </div>
            ...
            <form class="space-y-6" method="POST" action="?page=complete-jobseeker-profile&step=7">
                ...
                <div class="flex justify-between">
                    <a href="?page=complete-jobseeker-profile&step=6" class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-md shadow-sm hover:bg-gray-50">
