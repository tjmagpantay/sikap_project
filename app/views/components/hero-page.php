        ...
        <div class="hidden md:block">
          ...
          <div class="absolute flex items-center gap-2 p-3 text-sm text-black bg-white rounded-lg shadow-md top-4 right-4 w-[200px] animate-slide-in-right">
            <div class="flex items-center justify-center w-12 h-12 bg-blue-100 rounded-lg">
              <img src="./assets/images/bell.png" class="w-6 h-6" alt="Jobs Icon" />
          ...
          <div class="absolute flex items-center gap-2 px-4 py-2 text-sm text-black bg-white rounded-lg shadow-md bottom-4 right-4 w-[200px] opacity-90 animate-slide-in-right-delayed">
            <div class="flex flex-col items-start leading-tight">
