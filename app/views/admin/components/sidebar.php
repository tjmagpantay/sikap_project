<div class="flex flex-col h-full bg-white">
    ...
    <div class="flex-shrink-0 px-4 py-4 mb-4 border-t border-gray-200">
        <div class="flex items-center gap-3 mb-2">
            <div class="flex items-center justify-center w-10 h-10 p-3 rounded-md bg-primary">
        ...
        <div class="py-1">
            <a href="?page=admin-settings" class="flex items-center px-4 py-3 text-sm font-normal transition-colors rounded-lg text-primary hover:bg-blue-100">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="py-1 ">
            <a href="?page=admin-login" class="flex items-center px-4 py-3 text-sm font-normal text-red-600 transition-colors rounded-lg hover:bg-red-50">
                <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
