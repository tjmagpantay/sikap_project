...
<body class="bg-gray-100">
    <!-- Desktop Sidebar -->
    <div id="sidebar" class="fixed top-0 bottom-0 left-0 z-30 flex-col hidden h-screen px-6 py-4 transition-transform duration-300 ease-in-out transform bg-white border-r border-gray-200 w-80 lg:flex">
        <!-- Logo Section -->
        <div class="flex items-center justify-between flex-shrink-0 gap-6 py-2 border-b border-gray-200">
            <div class="flex items-center">
                <div class="flex items-center gap-2">
                    ...
                    <a href="?page=landing" class="text-xl font-semibold text-primary">
            ...
            <ul class="space-y-2">
                ...
                <li>
                    ...
                    <ul id="jobDropdown" class="hidden mt-2 ml-8 space-y-1">
                        <li>
                            <a href="?page=admin-jobs" class="flex items-center px-6 py-2 text-sm font-semibold text-gray-500 transition-colors rounded-lg hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <a href="?page=admin-job-categories" class="flex items-center px-6 py-2 text-sm font-semibold text-gray-500 transition-colors rounded-lg hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex-shrink-0 py-6 border-t border-gray-200">
            ...
            <div class="space-y-1">
                <a href="#" class="flex items-center py-2 text-sm font-normal text-gray-600 transition-colors rounded-lg hover:bg-gray-50">
    ...
    <div id="sidebar-overlay" class="fixed inset-0 z-20 hidden bg-black bg-opacity-50 lg:hidden" onclick="toggleMobileSidebar()"></div>

    <!-- Mobile Sidebar -->
    <div id="sidebar-mobile" class="fixed inset-y-0 left-0 z-30 transition-transform duration-300 ease-in-out transform -translate-x-full bg-white border-r border-gray-200 w-80 lg:hidden">
        <!-- Mobile Logo Section -->
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <div class="flex items-center">
                <div class="flex items-center gap-2">
                    <img src="assets/images/peso-logo.png" alt="Logo 2" class="w-auto h-8">
                    <img src="assets/images/sikap-logo.png" alt="Logo 1" class="w-auto h-8 shadow-sm">
                    <a href="?page=landing" class="text-xl font-semibold text-primary">Sikap <span class="font-semibold text-secondary">Admin</span></a>
                </div>
            </div>
            <button onclick="toggleMobileSidebar()" class="p-2 text-gray-400 hover:text-gray-600">
        ...
        <div class="px-8 py-4 border-b border-gray-200">
            <div class="relative">
                <svg class="absolute w-4 h-4 text-gray-400 -translate-y-1/2 pointer-events-none left-3 top-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m21 21-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
                <input
                    type="text"
                    placeholder="Search"
                    class="w-full py-2 pl-10 pr-4 text-sm border border-gray-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-secondary focus:border-secondary"
        ...
        <nav class="flex-1 px-6 py-4 overflow-y-auto">
            <ul class="space-y-2">
                <li>
                    <a href="?page=admin-dashboard" class="flex items-center px-4 py-3 text-sm font-medium text-gray-600 transition-colors rounded-lg hover:bg-gray-50">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <button type="button"
                        ...
                        onclick="toggleDropdown('userDropdownMobile', 'userDropdownArrowMobile')">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z" />
                        </svg>
                        <span class="text-sm font-normal ">User Management</span>
                        <svg id="userDropdownArrowMobile" class="w-4 h-4 ml-auto transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <ul id="userDropdownMobile" class="hidden mt-2 ml-8 space-y-1">
                        <li>
                            <a href="?page=admin-jobseekers" class="flex items-center px-6 py-2 text-sm font-semibold text-gray-500 transition-colors rounded-lg hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                                </svg>
                                <span>Jobseekers</span>
                        ...
                        <li>
                            <a href="?page=admin-employers" class="flex items-center px-6 py-2 text-sm font-semibold text-gray-500 transition-colors rounded-lg hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
                                </svg>
                                <span>Employers</span>
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full px-4 py-3 text-sm font-medium text-gray-600 transition-colors rounded-lg hover:bg-gray-50 focus:outline-none"
                        onclick="toggleDropdown('jobDropdownMobile', 'jobDropdownArrowMobile')">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span>Job Management</span>
                        <svg id="jobDropdownArrowMobile" class="w-4 h-4 ml-auto transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <ul id="jobDropdownMobile" class="hidden mt-2 ml-8 space-y-1">
                        <li>
                            <a href="?page=admin-jobs" class="flex items-center px-6 py-2 text-sm font-semibold text-gray-500 transition-colors rounded-lg hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v6a2 2 0 002 2h6a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                ...
                <li>
                    <a href="?page=admin-accreditations" class="flex items-center px-4 py-3 text-sm font-medium text-gray-600 transition-colors rounded-lg hover:bg-gray-50">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z" />
                        </svg>
                        <span>Accreditation</span>
                ...
                <li>
                    <a href="?page=admin-reports" class="flex items-center px-4 py-3 text-sm font-medium text-gray-600 transition-colors rounded-lg hover:bg-gray-50">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                        </svg>
                        <span>All Reports</span>
                ...
                <li>
                    <a href="?page=admin-applications" class="flex items-center px-4 py-3 text-sm font-medium text-gray-600 transition-colors rounded-lg hover:bg-gray-50">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                        <span>Applications</span>
                ...
                <li>
                    <a href="?page=admin-announcements" class="flex items-center px-4 py-3 text-sm font-medium text-gray-600 transition-colors rounded-lg hover:bg-gray-50">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <li>
                    <a href="?page=admin-chatbot" class="flex items-center px-4 py-3 text-sm font-medium text-gray-600 transition-colors rounded-lg hover:bg-gray-50">
                        <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
                        </svg>
                        <span>Chatbot / FAQ Manager</span>
                ...
                <li>
                    <button type="button"
                        ...
                        <span>Events & Programs</span>
                        <svg id="eventDropdownArrowMobile" class="w-4 h-4 ml-auto transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                        </svg>
                    </button>
                    <ul id="eventDropdownMobile" class="hidden mt-2 ml-8 space-y-1">
                        <li>
                            <a href="?page=admin-events" class="flex items-center px-6 py-2 text-sm font-semibold text-gray-500 transition-colors rounded-lg hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v6a2 2 0 002 2h6a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
                                </svg>
                                <span>All Events</span>
                        ...
                        <li>
                            <a href="?page=admin-event-create" class="flex items-center px-6 py-2 text-sm font-semibold text-gray-500 transition-colors rounded-lg hover:bg-gray-50">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                                </svg>
                                <span>Create Event</span>
        ...
        <div class="flex-shrink-0 p-6 border-t border-gray-200">
            ...
            <div class="space-y-1">
                <a href="#" class="flex items-center px-3 py-2 text-sm font-medium text-gray-600 transition-colors rounded-lg hover:bg-gray-50">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="?page=logout" class="flex items-center px-3 py-2 text-sm font-medium text-red-600 transition-colors rounded-lg hover:bg-red-50">
                    <svg class="w-4 h-4 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 16l4-4m0 0l-4-4m4 4H7m6 4v1a3 3 0 01-3 3H6a3 3 0 01-3-3V7a3 3 0 013-3h4a3 3 0 013 3v1" />
                    </svg>
                    <span>Log out</span>
