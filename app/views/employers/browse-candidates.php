                    ...
                    <div class="flex flex-wrap items-center gap-3" x-data="{ 
                        ...
                        <div class="relative">
                            <button @click="jobOpen = !jobOpen" @click.away="jobOpen = false"
                                class="inline-flex items-center justify-between w-48 px-4 py-3 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary">
