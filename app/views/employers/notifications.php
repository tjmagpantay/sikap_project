<?php
// filepath: c:\xampp\htdocs\sikap\app\views\employers\notifications.php

// Include authentication and navigation components
...
<div class="min-h-screen px-4 sm:px-6 md:px-16 lg:px-24">
    <div class="py-8 mx-auto sm:px-2 md:px-4 lg:px-12 max-w-7xl">
        ...
        <!-- Page Header - Same style as jobseeker -->
        <div class="mb-8">
        ...
        <div class="space-y-4">
            <?php if (empty($data['notifications'])): ?>
                <!-- Empty State - Similar to jobseeker layout -->
                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div class="py-12 text-center">
                        ...
                        <a href="?page=employer-dashboard" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white border border-transparent rounded-md shadow-sm bg-primary hover:bg-secondary">
            ...
            <?php else: ?>
                <!-- Notifications List - Updated Card Structure -->
                    ...
                    <div class="flex justify-center py-6 mt-8 border-t border-gray-200">
                        <div class="flex items-center gap-2">
                            <?php if ($data['currentPage'] > 1): ?>
                                <a href="?page=notifications-employer&p=<?php echo $data['currentPage'] - 1; ?>"
...
<!-- JavaScript - Enhanced with better visual feedback -->
<script>
    function markAsRead(notificationId) {
        ...
        fetch('?page=notifications-employer', {
                method: 'POST',
                body: formData
            })
            .then(response => {
