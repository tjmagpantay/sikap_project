    ...
    <div class="mx-auto max-w-7xl">
        ...
        <?php if (empty($data['notifications'])): ?>
            ...
            <div class="py-12 text-center">
                ...
                <a href="?page=employer-dashboard" class="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700">
