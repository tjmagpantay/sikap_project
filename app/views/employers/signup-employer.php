...
<script src="/sikap_development/app/views/components/terms-condi-employer.js"></script>
            ...
            <form class="space-y-6" method="POST" action="?page=signup-employer">
                <div>
                    ...
                    <input id="email" name="email" type="email" required 
                           class="block px-3 py-2 mt-1 w-full placeholder-gray-400 rounded-md border border-gray-300 appearance-none focus:outline-none focus:ring-secondary focus:border-secondary">
                </div>
