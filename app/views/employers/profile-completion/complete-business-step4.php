                            ...
                            <div class="flex justify-center px-4 pt-4 pb-4 transition-colors border-2 border-gray-300 border-dashed rounded-md hover:border-gray-400">
                                <div class="space-y-1 text-center">
                                    ...
                                    <div class="flex text-sm text-gray-600">
                                        <label for="<?php echo $type; ?>" class="relative font-medium bg-white rounded-md cursor-pointer text-primary hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-primary">
