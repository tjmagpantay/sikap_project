            ...
            <form id="businessStep3Form" class="space-y-6" method="POST" action="?page=complete-employer-business&step=3">
                ...
                <div>
                    ...
                    <div class="flex flex-col gap-3 md:flex-row md:items-center">
                        <div class="md:w-32 md:flex-shrink-0"> <!-- Fixed width for icon section -->
                            <div class="flex items-center h-full px-3 py-3 text-sm text-gray-700 border border-gray-300 rounded-md bg-gray-50">
                        ...
                        <div class="flex-1"> <!-- Takes remaining width -->
