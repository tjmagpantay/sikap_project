        ...
        <div class="mb-8">
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                ...
                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div class="mb-6">
                        <h3 class="mb-6 text-md text-gray-700 font-xl">New Job Post to review</h3>
                ...
                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div class="mb-6">
                        <h3 class="mb-6 text-md text-gray-700 font-xl">New Employer to review</h3>
                        <div class="flex items-baseline">
                ...
                <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-sm">
                    <div class="mb-6">
                        <h3 class="mb-6 text-md text-gray-700 font-xl">Active Job Posts</h3>
                    ...
                    <div class="w-full overflow-x-auto">
                        <table class="w-full divide-y divide-gray-200 table-fixed">
                            ...
                            <thead class="bg-primary">
                                <tr>
                                    <th scope="col" class="w-2/5 px-6 py-4 text-xs font-medium tracking-wider text-left text-white uppercase">
                                        JOBS
                                    </th>
                                    <th scope="col" class="w-1/6 px-6 py-4 text-xs font-medium tracking-wider text-left text-white uppercase">
                                        STATUS
                                    </th>
                                    <th scope="col" class="w-1/6 px-6 py-4 text-xs font-medium tracking-wider text-left text-white uppercase">
                                        APPLICATIONS
                                    </th>
                                    <th scope="col" class="w-1/4 px-6 py-4 text-xs font-medium tracking-wider text-left text-white uppercase">
                                        ACTIONS
                                    </th>
                                </tr>
                            </thead>
